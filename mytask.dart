  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                validator: (value){
                  if(value == null || int.parse(value) <= 000){
                    return "ID harus bilangan bulat";
                  }
                  return null;
                },
              ...
              TextFormField(
                ...
                validator: (value){
                  if(value == null || value.isEmpty){
                    return "Field nama tidak bisa kosong";
                  }
                  return null;
                }
              ),
              TextFormField(
                ...
                validator: (value){
                  if(value == null || int.parse(value) <= 100){
                    return "Harga harus dalam harga konversi";
                  }
                  return null;
                },
                keyboardType: TextInputType.number,
              ...
              TextFormField(
                ...
                validator: (value){
                  if(value == null || int.parse(value) < 0){
                    return "Stok harus bilangan bulat";
                  }
                  return null;
                },
                keyboardType: TextInputType.number,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          bool isValid = validationKey.currentState!.validate();
          if(!isValid) return;
          Navigator.pop(
            context,
            Product(
